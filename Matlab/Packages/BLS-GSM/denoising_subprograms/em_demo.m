...
[p_k_ym_subband_1, Cov_k_subband_1, p_z_k_1] = expec_maxim(subband_1,2*k,patchsize,gaussian_noise); 
[p_k_ym_subband_2, Cov_k_subband_2, p_z_k_2] = expec_maxim(subband_2,2*k,patchsize,gaussian_noise); 
[p_k_ym_subband_3, Cov_k_subband_3, p_z_k_3] = expec_maxim(subband_3,2*k,patchsize,gaussian_noise); 
[p_k_ym_subband_4, Cov_k_subband_4, p_z_k_4] = expec_maxim(subband_4,2*k,patchsize,gaussian_noise);
[p_k_ym_subband_5, Cov_k_subband_5, p_z_k_5] = expec_maxim(subband_5,2*k,patchsize,gaussian_noise); 
[p_k_ym_subband_6, Cov_k_subband_6, p_z_k_6] = expec_maxim(subband_6,2*k,patchsize,gaussian_noise); 
